...
const static IndicationRule_t doubleHead4IndicationWesternUS[] = 
{
	...
	{ INDICATION_ADVANCE_APPROACH,      SignalMast::DIVMASK_DIV_HIGH_SPD,  ASPECT_RED,       ASPECT_FL_YELLOW, ASPECT_OFF,      },
	{ INDICATION_ADVANCE_APPROACH,      SignalMast::DIVMASK_DIV_NO_HSPD ,  ASPECT_RED,       ASPECT_YELLOW,    ASPECT_OFF,      },
	{ INDICATION_APPROACH_DIVERGING_AA, SignalMast::DIVMASK_DIV_HIGH_SPD,  ASPECT_RED,       ASPECT_FL_YELLOW, ASPECT_OFF,      },
	{ INDICATION_APPROACH_DIVERGING_AA, SignalMast::DIVMASK_DIV_NO_HSPD ,  ASPECT_RED,       ASPECT_YELLOW,    ASPECT_OFF,      },
	{ INDICATION_CLEAR,                 SignalMast::DIVMASK_DIV_NO_HSPD ,  ASPECT_RED,       ASPECT_YELLOW,    ASPECT_OFF,      },
	{ INDICATION_CLEAR,                 SignalMast::DIVMASK_DIV_HIGH_SPD,  ASPECT_RED,       ASPECT_YELLOW,    ASPECT_OFF,      }
};
...
const static IndicationRule_t tripleHead4Indication[] = 
{
	...
	{ INDICATION_APPROACH,              SignalMast::DIVMASK_DIV_LOW_SPD,   ASPECT_RED,       ASPECT_RED,       ASPECT_YELLOW    },
	{ INDICATION_APPROACH,              SignalMast::DIVMASK_ALL_DIVERGING, ASPECT_RED,       ASPECT_YELLOW,    ASPECT_RED       },

	{ INDICATION_APPROACH_DIVERGING,    SignalMast::DIVMASK_DIV_LOW_SPD,   ASPECT_RED,       ASPECT_YELLOW,    ASPECT_GREEN     },
	{ INDICATION_APPROACH_DIVERGING,    SignalMast::DIVMASK_ALL_DIVERGING, ASPECT_YELLOW,    ASPECT_GREEN,     ASPECT_RED       },

	{ INDICATION_APPROACH_DIVERGING_AA, SignalMast::DIVMASK_DIV_LOW_SPD,   ASPECT_RED,       ASPECT_RED,       ASPECT_FL_YELLOW },
	{ INDICATION_APPROACH_DIVERGING_AA, SignalMast::DIVMASK_ALL_DIVERGING, ASPECT_RED,       ASPECT_FL_YELLOW, ASPECT_RED       },
	{ INDICATION_ADVANCE_APPROACH,      SignalMast::DIVMASK_DIV_LOW_SPD,   ASPECT_RED,       ASPECT_RED,       ASPECT_FL_YELLOW },
	{ INDICATION_ADVANCE_APPROACH,      SignalMast::DIVMASK_ALL_DIVERGING, ASPECT_RED,       ASPECT_FL_YELLOW, ASPECT_RED       },
	{ INDICATION_CLEAR,                 SignalMast::DIVMASK_DIV_LOW_SPD,   ASPECT_RED,       ASPECT_RED,       ASPECT_GREEN     },
